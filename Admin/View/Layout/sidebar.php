                ...
                <div class="accordion">
                    ...
                    <section class="accordion-item">
                        <a href="#" style="text-decoration: none">
                            <div class="sb-nav-link-icon" style="color:rgba(255, 255, 255, 0.5) "><i class="fas fa-th"></i>&ensp;Danh sách phim</div>
                        </a>
                        <div class="accordion-item-content">
                            ...
                            <a href="<?= URLCATEGORY?>index&&page=1" style="text-decoration: none">
                                <div class="sb-nav-link-icon" style="color:rgba(255, 255, 255, 0.5) ;padding: 10px 30px"><i class="fas fa-list"></i>&nbsp; Quản lý DS </div>
                            </a>
                        </div>
                    </section>
                    <section class="accordion-item">
                        ...
                        <div class="accordion-item-content">
                            ...
                            <a href="<?=  URLPOST ?>index&&page=1" style="text-decoration: none">
                                <div class="sb-nav-link-icon" style="color:rgba(255, 255, 255, 0.5) ;padding: 10px 30px"><i class="fas fa-list"></i>&nbsp; Quản lý BV  </div>
                            </a>
                        </div>
                    </section>
                    <section class="accordion-item">
