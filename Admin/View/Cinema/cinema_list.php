    ...
    <div id="layoutSidenav_content">
        ...
        <main style="background-color: #fdfcf0">
            ...
            <div class="addcategory" style="padding: 20px 30px ; border-radius: 10px ">
                <a href="#" class="btn btn-info" style="color: #FFFFFF;font-weight: 500">Thêm mới rạp phim</a>
            </div>
            <div class="container-fluid px-4 categoriesWrap">
                <form class="table_left">
                    ...
                    <table class="table">
                        ...
                        ?>
                        <?php
                        foreach ($cinemas[0] as $index => $cinema) { ?>
                            <tr>
                                <td><?= $index + 1 + $cinemas[2] * ($cinemas[3] - 1) ?></td>
                                <td style="text-align: center"><?=$cinema["nameCinema"]?></td>
                                <td style="text-align: center">
                                    <a href="#" class="btn btn-success">Edit</a>
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal<?= $index + 1 + $cinemas[2] * ($cinemas[3] - 1) ?>">
                                        Delete
                                    </button>
                                    <div class="modal fade"
                                         id="exampleModal<?= $index + 1 + $cinemas[2] * ($cinemas[3] - 1) ?>"
