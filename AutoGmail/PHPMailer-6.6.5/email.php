...
function send_email($email_recive,$name,$contents,$subject){
    ...
    $mail->AddReplyTo("zentgroup@gmail.com","TIVHStore");// Ấn định email sẽ nhận khi người dùng reply lại.
...
$subject="Test_1";
send_email("tungnguyen0603202@gmail.com","NGuyễn Việt Tùng",$contents,$subject);